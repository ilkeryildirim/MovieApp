...
class ProfileConstants {
  ...
  static const double moviesTitleToGridSpacing = 16.0;
  ...
  /// Opacity values
  static const double backButtonBackgroundAlpha = 0.3;
  static const double photoBorderAlpha = 0.2;
  static const double userIdAlpha = 0.5;
  static const double movieDirectorAlpha = 0.5;
  static const double shimmerBaseAlpha = 0.2;
  static const double shimmerHighlightAlpha = 0.4;
  ...
  static Color get backButtonBackground => Colors.black.withValues(alpha: backButtonBackgroundAlpha);
  ...
  static Color get shimmerBaseColor => Colors.grey.withValues(alpha: shimmerBaseAlpha);
  static Color get shimmerHighlightColor => Colors.grey.withValues(alpha: shimmerHighlightAlpha);
  static Color get shimmerContainerColor => Colors.grey.withValues(alpha: shimmerBaseAlpha);
